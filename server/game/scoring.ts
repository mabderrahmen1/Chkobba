 ...
 */
export function countBySuit(capturedCards: Card[]): Record<string, number> {
 ...
 */
export function countRank(capturedCards: Card[], rank: string): number {
 ...
 */
export function calculateCarta(team0Cards: Card[], team1Cards: Card[]) {
 ...
 * @returns {Object} { team0: points, team1: points }
 */
export function calculateDinari(team0Cards: Card[], team1Cards: Card[]) {
 ...
 * @returns {Object} { team0: points, team1: points }
 */
export function calculateBermila(team0Cards: Card[], team1Cards: Card[]) {
 ...
 * @returns {Object} { team0: points, team1: points }
 */
export function calculateSabaaElHaya(team0Cards: Card[], team1Cards: Card[]) {
  const team0HasSevenDiamonds = team0Cards.some(
    card => card.rank === '7' && card.suit === rules.SUITS.DIAMONDS
  );
  const team1HasSevenDiamonds = team1Cards.some(
    card => card.rank === '7' && card.suit === rules.SUITS.DIAMONDS
  );
 ...
 * @returns {Object} { team0: points, team1: points }
 */
export function calculateChkobba(team0Chkobba: number, team1Chkobba: number) {
  return {
    team0: team0Chkobba,
    team1: team1Chkobba
  };
