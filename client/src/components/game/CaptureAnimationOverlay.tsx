...
export function CaptureAnimationOverlay() {
  ...
  useEffect(() => {
    if (lastAction && lastAction.type === 'capture') {
      ...
      const timer = setTimeout(() => setActiveAction(null), 1500);
      ...
      <AnimatePresence>
        ...
        >
          ...
          <motion.div
            ...
            animate={{ y: isSmall ? -120 : -180, opacity: 1, scale: 1 }}
            className={`absolute font-bold text-2xl sm:text-5xl uppercase tracking-widest ${
              isChkobba ? 'text-accent' : isHayya ? 'text-team2' : 'text-text-primary'
            }`}
          >
          ...
          <div className="relative flex items-center justify-center gap-4 sm:gap-16">
            ...
            <motion.div
              ...
              animate={{ scale: isSmall ? 1.1 : 1.4, x: isSmall ? -60 : -100, y: 0, rotate: -5 }}
            ...
            <motion.div
              ...
              animate={{ scale: isSmall ? 1.1 : 1.5, rotate: 0 }}
              transition={{ delay: 0.3, type: 'spring' }}
              className="text-text-tertiary text-2xl sm:text-5xl font-bold"
            >
              &#10141;
            </motion.div>
